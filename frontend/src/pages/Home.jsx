            ...
            <div>
              <div className="lg:w-[570px]">
                <h1 className="text-[36px] leading-[46px] text-headingColor font-[800] md:text-[45px] md:leading-[70px]">
                  Your AI-Powered Health Companion — <span className="text-primaryColor">Medora</span>
                </h1>
                <p className="text__para">
                  Describe your symptoms in plain English and get a detailed AI health report. Find top doctors near your city in seconds. Medora makes healthcare accessible, intelligent, and personal.
                </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 lg:gap-[30px] mt-[30px] lg:mt-[55px]">
            <div className="py-[30px] px-5">
              ...
              <div className="mt-[30px]">
                ...
                <p className="text-[16px] leading-7 text-textColor font-[400] mt-4 text-center">
                  Describe your symptoms in plain English and get a comprehensive AI-generated health report with precautions and remedies.
                </p>
                <Link
                  to="/symptomchk"
            ...
            <div className="py-[30px] px-5">
              ...
              <div className="mt-[30px]">
                ...
                <p className="text-[16px] leading-7 text-textColor font-[400] mt-4 text-center">
                  Search for top doctors and hospitals in your city. Get contact details, ratings, specializations and timings instantly.
                </p>
                <Link
                  to="/doctors"
                  className="w-[44px] h-[44px] rounded-full border border-solid border-[#181A1E] mt-[30px] mx-auto flex items-center justify-center group hover:bg-primaryColor hover:border-none"
            ...
            <div className="py-[30px] px-5">
              ...
              <div className="mt-[30px]">
                ...
                <p className="text-[16px] leading-7 text-textColor font-[400] mt-4 text-center">
                  Download detailed PDF health reports generated by AI — share them with your doctor for an informed consultation.
                </p>
                <Link
                  to="/symptomchk"
                  className="w-[44px] h-[44px] rounded-full border border-solid border-[#181A1E] mt-[30px] mx-auto flex items-center justify-center group hover:bg-primaryColor hover:border-none"
